...
//                     .then(user => {
//                         //when the .then() happens that means that the user from the form was successsfully created and is stored in that variable "user" which has info about the user that was just put into the db, including the field _id
...
//                 }else{
//                     //else --> the email is already taken so we will json back an error message
